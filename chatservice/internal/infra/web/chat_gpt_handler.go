...
type WebChatGTPHandler struct {
	CompletionUseCase chatcompletion.ChatCompletionUseCase
	Config            chatcompletion.ChatCompletionConfigInputDTO
	AuthToken         string
}

func NewWebChatGTPHandler(usecase chatcompletion.ChatCompletionUseCase, config chatcompletion.ChatCompletionConfigInputDTO, authToken string) *WebChatGTPHandler {
	return &WebChatGTPHandler{
...
func (h *WebChatGTPHandler) Handle(w http.ResponseWriter, r *http.Request) {
